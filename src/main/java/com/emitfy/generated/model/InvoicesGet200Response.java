...
import com.emitfy.generated.model.InvoicesGet200ResponseData;
...
public class InvoicesGet200Response {
  ...
  @javax.annotation.Nullable
  private InvoicesGet200ResponseData data;
  ...
  public InvoicesGet200Response data(@javax.annotation.Nullable InvoicesGet200ResponseData data) {
    this.data = data;
    return this;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public InvoicesGet200ResponseData getData() {
    return data;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable InvoicesGet200ResponseData data) {
    this.data = data;
  }
