...
import com.emitfy.generated.model.NfseCreateRequestConstruction;
import com.emitfy.generated.model.NfseCreateRequestIbsCbs;
import com.emitfy.generated.model.NfseCreateRequestIntermediary;
import com.emitfy.generated.model.NfseCreateRequestIss;
import com.emitfy.generated.model.NfseCreateRequestSubstitution;
...
@JsonPropertyOrder({
  ...
  NfseCreateRequest.JSON_PROPERTY_INTERMEDIARY,
  NfseCreateRequest.JSON_PROPERTY_CONSTRUCTION,
  NfseCreateRequest.JSON_PROPERTY_SUBSTITUTION,
...
public class NfseCreateRequest {
  ...
  @javax.annotation.Nullable
  private NfseCreateRequestIntermediary intermediary;

  public static final String JSON_PROPERTY_CONSTRUCTION = "construction";
  @javax.annotation.Nullable
  private NfseCreateRequestConstruction construction;

  public static final String JSON_PROPERTY_SUBSTITUTION = "substitution";
  @javax.annotation.Nullable
  private NfseCreateRequestSubstitution substitution;
  ...
  public NfseCreateRequest taxes(@javax.annotation.Nullable NfseCreateRequestTaxes taxes) {
    this.taxes = taxes;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_TAXES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setTaxes(@javax.annotation.Nullable NfseCreateRequestTaxes taxes) {
    this.taxes = taxes;
  }
  ...
  public NfseCreateRequest intermediary(@javax.annotation.Nullable NfseCreateRequestIntermediary intermediary) {
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public NfseCreateRequestIntermediary getIntermediary() {
    return intermediary;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_INTERMEDIARY, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIntermediary(@javax.annotation.Nullable NfseCreateRequestIntermediary intermediary) {
    this.intermediary = intermediary;
  }


  public NfseCreateRequest construction(@javax.annotation.Nullable NfseCreateRequestConstruction construction) {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_CONSTRUCTION, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public NfseCreateRequestConstruction getConstruction() {
    return construction;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_CONSTRUCTION, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setConstruction(@javax.annotation.Nullable NfseCreateRequestConstruction construction) {
    this.construction = construction;
  }


  public NfseCreateRequest substitution(@javax.annotation.Nullable NfseCreateRequestSubstitution substitution) {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_SUBSTITUTION, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public NfseCreateRequestSubstitution getSubstitution() {
    return substitution;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_SUBSTITUTION, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSubstitution(@javax.annotation.Nullable NfseCreateRequestSubstitution substitution) {
    this.substitution = substitution;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.serviceDescription, nfseCreateRequest.serviceDescription) &&
        ...
        Objects.equals(this.intermediary, nfseCreateRequest.intermediary) &&
        Objects.equals(this.construction, nfseCreateRequest.construction) &&
        Objects.equals(this.substitution, nfseCreateRequest.substitution) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(serviceDescription, name, sku, category, guarantee, cityServiceCode, federalServiceCode, nbs, cnaeCode, iss, ibsCbs, natureOfOperation, serviceLocation, municipalityOfIncidence, taxes, amount, issueDate, externalId, borrower, intermediary, construction, substitution, serviceCode, serviceItemCode, nbsCode, taxClassification, ibsCst, ibsOperationIndicator);
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getIntermediary() != null) {
      joiner.add(getIntermediary().toUrlQueryString(prefix + "intermediary" + suffix));
    }

    // add `construction` to the URL query string
    if (getConstruction() != null) {
      joiner.add(getConstruction().toUrlQueryString(prefix + "construction" + suffix));
    }

    // add `substitution` to the URL query string
    if (getSubstitution() != null) {
      joiner.add(getSubstitution().toUrlQueryString(prefix + "substitution" + suffix));
    }
